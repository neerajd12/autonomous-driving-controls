      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          msgJson["cte"] = polyeval(coeffs, 0);
          msgJson["epsi"] = atan(coeffs[1]);
          Eigen::VectorXd state(6);
          state << 0, 0, 0, v, msgJson["cte"], msgJson["epsi"];
          vector<double> actuator_values = mpc.Solve(state, coeffs);
          msgJson["steering_angle"] = actuator_values[0] / -deg2rad(25);
          msgJson["throttle"] = actuator_values[1];
